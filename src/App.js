...
function App() {
  ...
  return (
    <div className="App">
      ...
      <AppContext.Provider value={{ letterBoard, setLetterBoard, presentAttempt, setPresentAttempt, onPickLetter, onEnterButton, onDeleteLetter ,checkcorrect ,}}>
        <div className='game'>
          <LetterBoard />
        </div>
        <div className='game'>
